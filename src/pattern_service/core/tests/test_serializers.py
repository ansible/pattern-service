...
class PatternSerializerTest(SharedTestFixture):
    def test_serializer_fields_present(self):
        ...
        self.assertEqual(
            data["collection_version_uri"],
            "https://example.com/mynamespace/mycollection/",
        )
...
class AutomationSerializerTest(SharedTestFixture):
    ...
    def test_serializer_fields_present(self):
        ...
        self.assertEqual(
            data["automation_type"], self.automation.automation_type
        )
...
class TaskSerializerTest(SharedTestFixture):
    def test_serializer_fields_present(self):
        task = Task.objects.create(
            status="Initiated", details={"info": "test"}
        )
    ...
    def test_serializer_validation_success(self):
        ...
        self.assertEqual(
            serializer.validated_data["details"],
            {"step": 1, "info": "in progress"},
        )
